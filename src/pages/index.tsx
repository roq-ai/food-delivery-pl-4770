  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Welcome to Food Delivery Platform, your ultimate destination for food ordering and delivery. Experience the joy of hassle-free dining at your fingertips."
        />
      </Head>
      <ConfigureCodeBanner
      ...
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1695653420013-47c8e156e0af?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MXwxfHNlYXJjaHwxfHxmb29kJTIwZGVsaXZlcnl8ZW58MHx8fHwxNjk2ODAxNTg0fDA&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Welcome to Food Delivery Platform, your ultimate destination for food ordering and delivery. Experience the joy of hassle-free dining at your fingertips.`}
            </Text>
            <Box
