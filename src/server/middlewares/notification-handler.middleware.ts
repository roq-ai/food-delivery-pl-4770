...
const notificationMapping: Record<string, NotificationConfigInterface> = {
  'Order #123 has been placed by Customer.create': {
    roles: ['restaurant-owner', 'restaurant-manager', 'customer-service-representative'],
    key: 'order_create',
    tenantPath: [],
    userPath: [],
  },
  'Order #123 has been picked up by Delivery Driver.update': {
    roles: ['restaurant-owner', 'restaurant-manager', 'customer-service-representative'],
    key: 'order_pickup',
    tenantPath: [],
    userPath: [],
  },
  'Feedback for Order #123 has been submitted by Customer.create': {
    roles: ['restaurant-owner', 'restaurant-manager', 'customer-service-representative'],
    key: 'feedback_create',
    tenantPath: [],
    userPath: [],
